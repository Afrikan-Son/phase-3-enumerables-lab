...
spicy_foods_array = spicy_foods
puts get_names(spicy_foods_array)
puts spiciest_foods(spicy_foods_array)
print_spicy_foods(spicy_foods_array)
puts get_spicy_food_by_cuisine(spicy_foods_array, "American")
puts sort_by_heat(spicy_foods_array)
print_spiciest_foods(spicy_foods_array)
puts average_heat_level(spicy_foods_array)